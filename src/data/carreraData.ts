...
export const CARRERA_SUBJECTS: CarreraSubject[] = [
  ...
  { id: 'c-072', codigo: '3.4.072', nombre: 'Arquitectura de Computadores',           año: 1, correlativas: [] },
  { id: 'c-024', codigo: '3.1.024', nombre: 'Matemática Discreta',                    año: 1, correlativas: [] },
  ...
  { id: 'c-052', codigo: '3.1.052', nombre: 'Física I',                               año: 2, correlativas: ['c-051'] },
  { id: 'c-053', codigo: '3.1.053', nombre: 'Cálculo I',                              año: 2, correlativas: [] },
  { id: 'c-077', codigo: '3.4.077', nombre: 'Programación III',                       año: 2, correlativas: ['c-074'] },
  { id: 'c-208', codigo: '3.4.208', nombre: 'Paradigma Orientado a Objetos',          año: 2, correlativas: ['c-071'] },
  { id: 'c-078', codigo: '3.4.078', nombre: 'Fundamentos de Telecomunicaciones',      año: 2, correlativas: [] },
  ...
  // ── 3er Año ──────────────────────────────────────────────────────────────
  { id: 'c-210', codigo: '3.4.210', nombre: 'Proceso de Desarrollo de Software',     año: 3, correlativas: ['c-208'] },
  { id: 'c-211', codigo: '3.4.211', nombre: 'Seminario de Integración Profesional',  año: 3, correlativas: ['c-207', 'c-209'] },
  ...
  { id: 'c-049', codigo: '3.1.049', nombre: 'Probabilidad y Estadística',             año: 3, correlativas: ['c-053'] },
  { id: 'c-082', codigo: '3.4.082', nombre: 'Aplicaciones Interactivas',              año: 3, correlativas: ['c-210'] },
  { id: 'c-214', codigo: '3.4.214', nombre: 'Ingeniería de Software',                 año: 3, correlativas: ['c-207'] },
  { id: 'c-055', codigo: '3.1.055', nombre: 'Física II',                              año: 3, correlativas: ['c-052'] },
  { id: 'c-215', codigo: '3.4.215', nombre: 'Teoría de la Computación',               año: 3, correlativas: ['c-024', 'c-077'] },
  { id: 'c-056', codigo: '3.1.056', nombre: 'Estadística Avanzada',                   año: 3, correlativas: ['c-049'] },

  // ── 4to Año ──────────────────────────────────────────────────────────────
  { id: 'c-216', codigo: '3.4.216', nombre: 'Desarrollo de Aplicaciones I',           año: 4, correlativas: ['c-210'] },
  { id: 'c-089', codigo: '3.4.089', nombre: 'Dirección de Proyectos Informáticos',    año: 4, correlativas: ['c-207'] },
  { id: 'c-217', codigo: '3.4.217', nombre: 'Ciencia de Datos',                       año: 4, correlativas: ['c-213', 'c-049'] },
  { id: 'c-092', codigo: '3.4.092', nombre: 'Seguridad e Integridad de la Información', año: 4, correlativas: ['c-212'] },
  { id: 'c-025', codigo: '3.1.025', nombre: 'Modelado y Simulación',                  año: 4, correlativas: ['c-054'] },
  { id: 'c-218', codigo: '3.4.218', nombre: 'Desarrollo de Aplicaciones II',          año: 4, correlativas: ['c-216'] },
  { id: 'c-088', codigo: '3.4.088', nombre: 'Evaluación de Proyectos Informáticos',   año: 4, correlativas: ['c-049'] },
  { id: 'c-096', codigo: '3.4.096', nombre: 'Inteligencia Artificial',                año: 4, correlativas: ['c-056'] },
  ...
  // ── 5to Año ──────────────────────────────────────────────────────────────
  { id: 'c-094', codigo: '3.4.094', nombre: 'Arquitectura de Aplicaciones',           año: 5, correlativas: ['c-207'] },
  { id: 'c-220', codigo: '3.4.220', nombre: 'Tendencias Tecnológicas',                año: 5, correlativas: [] },
  { id: 'c-100', codigo: '3.4.100', nombre: 'Proyecto Final de Ingeniería',           año: 5, correlativas: [] },
  { id: 'c-pps', codigo: 'PPS06',   nombre: 'Práctica Profesional Supervisada',       año: 5, correlativas: [] },
