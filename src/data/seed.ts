...
const cuatriNumero: 1 | 2 = isFirstHalf ? 1 : 2
const cuatriId = `c${cuatriNumero}-${year}`

const c1: Cuatrimestre = {
  id: cuatriId,
  nombre: `${cuatriNumero === 1 ? '1er' : '2do'} Cuatrimestre ${year}`,
  año: year,
  numero: cuatriNumero,
  fechaInicio: isFirstHalf ? `${year}-03-01` : `${year}-08-03`,
  fechaFin: isFirstHalf ? `${year}-07-31` : `${year}-12-31`,
}

const materias: Materia[] = [
  {
    id: 'm1', cuatrimestreId: cuatriId, nombre: 'Programación III',
  ...
  {
    id: 'm2', cuatrimestreId: cuatriId, nombre: 'Paradigma Orientado a Objetos',
  ...
  {
    id: 'm3', cuatrimestreId: cuatriId, nombre: 'Dirección de Proyectos Informáticos',
  ...
  {
    id: 'm4', cuatrimestreId: cuatriId, nombre: 'Tecnología y Medio Ambiente',
  ...
  {
    id: 'm5', cuatrimestreId: cuatriId, nombre: 'Cálculo II',
  ...
  {
    id: 'm6', cuatrimestreId: cuatriId, nombre: 'Derecho Informático',
  ...
  {
    id: 'm7', cuatrimestreId: cuatriId, nombre: 'Ingeniería de Software',
    tipo: 'intensiva', regimen: 'examen_final', curso: '588325', aula: 'Aula Pinamar',
    color: 'amber', horarios: [],
    periodoIntensivo: { desde: `${year}-10-26`, hasta: `${year}-10-31`, inicio: '07:00', fin: '17:30' },
    orden: 7,
...
const evaluaciones: Evaluacion[] = [
  ...
  { id: 'e-m1-f', materiaId: 'm1', tipo: 'final', nombre: 'Examen Final', fecha: `${year}-12-07`, estado: 'programado' },

  // Paradigma OO (virtual — solo 1 parcial)
  { id: 'e-m2-p1', materiaId: 'm2', tipo: 'parcial_1', nombre: 'Parcial 1', estado: 'pendiente_fecha' },
  { id: 'e-m2-f', materiaId: 'm2', tipo: 'final', nombre: 'Examen Final', fecha: `${year}-12-09`, estado: 'programado' },
  ...
  { id: 'e-m3-tf', materiaId: 'm3', tipo: 'trabajo_final', nombre: 'Trabajo Final', fecha: `${year}-12-21`, estado: 'programado' },
  ...
  { id: 'e-m4-f', materiaId: 'm4', tipo: 'final', nombre: 'Examen Final', fecha: `${year}-12-09`, estado: 'programado' },
  ...
  { id: 'e-m5-f', materiaId: 'm5', tipo: 'final', nombre: 'Examen Final', fecha: `${year}-12-09`, estado: 'programado' },
  ...
  { id: 'e-m6-f', materiaId: 'm6', tipo: 'final', nombre: 'Final (solo si no promociona)', fecha: `${year}-12-17`, estado: 'programado' },
  ...
  { id: 'e-m7-f', materiaId: 'm7', tipo: 'final', nombre: 'Examen Final Intensiva', fecha: `${year}-10-31`, estado: 'programado' },
]
